...
const THEME_OPTIONS: ThemeOption[] = [
  { mode: "light", label: "Acik", icon: "white-balance-sunny" },
...
export const SettingsScreen = ({
  ...
  const buttonWidth = Math.max((width - 48) / 4 - 6, 50);
    ...
    >
      ...
      <View
        style={[
          ...
          { borderBottomColor: theme.surface, flexDirection: "column", alignItems: "stretch" },
        ]}
      >
      ...
      >
        ...
        <Text style={appStyles.logoutButtonText}>Cikis Yap</Text>
      </TouchableOpacity>
    </ScrollView>
  );
};
