...
def build_loaders(
    ...
    train_tf = build_train_transform(img_size=img_size, field_domain_rand=field_domain_rand)
    eval_tf = build_eval_transform(img_size=img_size)
